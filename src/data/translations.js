...
export const T = {
  cn: {
    ...
    authOr:"或", authUsernamePh:"用户名", authPasswordPh:"密码（至少6位）",
    authSignIn:"登录", authSignUp:"注册",
    authToggleToSignup:"没有账号？点击注册", authToggleToSignin:"已有账号？点击登录",
    authUsernameInvalid:"用户名需为3-20位字母、数字或下划线", authPasswordInvalid:"密码至少需要6位",
    authUsernameTaken:"该用户名已被注册", authFailed:"用户名或密码错误",
    authShowPassword:"显示密码", authHidePassword:"隐藏密码",
  ...
  en: {
    ...
    authOr:"or", authUsernamePh:"Username", authPasswordPh:"Password (min 6 characters)",
    authSignIn:"Sign in", authSignUp:"Sign up",
    authToggleToSignup:"No account? Sign up", authToggleToSignin:"Have an account? Sign in",
    authUsernameInvalid:"Username must be 3-20 letters, numbers, or underscores", authPasswordInvalid:"Password must be at least 6 characters",
    authUsernameTaken:"That username is already taken", authFailed:"Incorrect username or password",
